...
<i><b>🍃 Bᴏᴛ Mᴀɪɴᴛᴀɪɴᴇᴅ Bʏ :</b>@juliusnaywin</i>"""
...
<u>🔸 𝗪𝗔𝗥𝗡𝗜𝗡𝗚 🚸</u>\n
<b>🔞 Pʀᴏɴ ᴄᴏɴᴛᴇɴᴛꜱ ʟᴇᴀᴅꜱ ᴛᴏ ᴘᴇʀᴍᴀɴᴇɴᴛ ʙᴀɴ ʏᴏᴜ.</b>\n
<i>Cᴏɴᴛᴀᴄᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ (ᴏʀ) ʀᴇᴘᴏʀᴛ ʙᴜɢꜱ</i> <b>: <a href='https://t.me/juliusnaywin'>[ ᴄʟɪᴄᴋ ʜᴇʀᴇ ]</a></b>"""

ABOUT_TEXT = """
<b>⚜ Mʏ ɴᴀᴍᴇ : 𝐒𝐡𝐚𝐧𝐆𝐞𝐧𝐞𝐫𝐚𝐭𝐨𝐫</b>\n
<b>🔸𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 : <a href='https://t.me/juliusnaywin'>🆂🅷🅰🅽🅶🆈🅸</a></b>\n
<b>🔹𝐎𝐫𝐢𝐠𝐢𝐧𝐚𝐥 𝐒𝐨𝐮𝐫𝐜𝐞 : <a href='https://github.com/avipatilpro/FileStreamBot'>Cʟɪᴄᴋ Hᴇʀᴇ</a></b>\n
<b>🔸𝐆𝐢𝐭𝐇𝐮𝐛 : <a href='https://GitHub.com/avipatilpro'>𝐅𝐨𝐥𝐥𝐨𝐰 𝐎𝐰𝐧𝐞𝐫</a></b>\n
<b>🔹𝐑𝐞𝐩𝐨𝐎𝐰𝐧𝐞𝐫 : <a href='https://telegram.me/Avishkarpatil'>Aᴠɪsʜᴋᴀʀ Pᴀᴛɪʟ</a></b>"""
...
<i>🍃 Bᴏᴛ Mᴀɪɴᴛᴀɪɴᴇᴅ Bʏ :</i> <b>@juliusnaywin</b>
"""
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL is not None:
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ [ShanGyi](https://t.me/juliusnaywin).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
